...
<section id="vendors">
  ...
  <ul id="vendor_posters" class="filter_container">
    ...
    <li class="vendor">
      <img class="logo" src="/z_logos/vendors/blue_bottle_coffee.png" alt="Blue Bottle Coffee">
      <div class="payload">
        <div class="inner">
    ...
    <li class="vendor">
      <img class="logo" src="/z_logos/vendors/hard_water.png" alt="Hard Water">
      <div class="payload">
        <div class="inner">
    ...
    <li class="vendor">
      <img class="logo" src="/z_logos/vendors/state_bird_provisions.gif" alt="State Bird Provisions">
      <div class="payload">
        <div class="inner">
    ...
    <li class="vendor">
      <img class="logo" src="/z_logos/vendors/tacolicious.gif" alt="Tacolicious">
      <div class="payload">
        <div class="inner">
    ...
    <li class="vendor">
      <img class="logo" src="/z_logos/vendors/to_hyang.gif" alt="To Hyang">
      <div class="payload">
        <div class="inner">
