  ...
  <section class="kraft">
    ...
    <div class="inner">
      <section id="intro">
        ...
        <h1>La Cocina Food &amp; Entrepreneurship Conference</h1>
        <h2>Bringing Home the Chicharrones:<br/>Making it in Food</h2>
      ...
      <section id="details">
        ...
        <ol>
          ...
          <li><em>Making Made in SF Real:</em> SF Planning and <a href="http://www.spur.org/">SPUR</a> will present their finding on what it would take to make San Francisco a hub for food manufacturing, and invite the audience to brainstorm solutions.</li>
          <li><em>Cities + Festival + Foods:</em> A m&eacute;lange of ethnicities and cultures discussing how they&rsquo;re using food + food festivals as a tool to bring communities together in their home cities. We&rsquo;ll have food festival hosts from Brazil, New Zealand, and Sweden!</li>
          <li><em>Packaging + Branding:</em> interactive session with <a href="http://www.ideo.com/">IDEO</a> working on prototyping for food packaging, as well as insight into what makes a strong and successful food brand.</li>
          <li><em>Investment Readiness for Food Businesses:</em> An interactive workshop hosted by Friday Consulting will talk about investment readiness and help producers work on their personal pitches.</li>
        </ol>

        <p>Our newest addition this year is the Art + Food Expo, which will be running alongside the lunch break; it will be a chance for the conference attendees to interact with ideas around food and city spaces through art and activities. We will have <a href="http://www.madelenefarin.com/">Madelene Farin</a> with her Foodscapes exhibition, <a href="http://www.nomadgardens.org/">Nomad Gardens</a> holding a fun, hands-on activity, Eat Bugs! by <a href="http://www.donbugito.com/">Don Bugito</a>, amongst others!</p>
      ...
      <section id="schedule">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td></td>
              <td colspan="3">A Day in the Life of a Food Entrepreneur</td>
            </tr>
            <tr>
              <td></td>
              <td colspan="3">Barriers to Food Entrepreneurship in San Francisco</td>
            </tr>
            <tr>
              <td colspan="4"></td>
            </tr>
            <tr class="primary header">
              <td class="time">11:15-12:30</td>
              <td>Learn</td>
              <td>Do</td>
              <td>Discuss</td>
            </tr>
            <tr>
              <td></td>
              <td>Financing to Scale a Food Business</td>
              <td>Making it Local: Solutions for San Francisco</td>
              <td>The Future of How We Will Buy Food</td>
            </tr>
            <tr>
              <td colspan="4"></td>
            </tr>
            <tr class="primary">
              ...
              <td colspan="3">Lunch with Food + Art Expo</td>
            </tr>
            <tr>
              <td colspan="4"></td>
            </tr>
            <tr class="primary header">
              <td class="time">14:15-15:30</td>
              <td>Learn</td>
              <td>Do</td>
              <td>Discuss</td>
            </tr>
            <tr>
              <td></td>
              <td>Is Ethnic Food Undervalued?</td>
              <td>Getting Ready for Investment</td>
              <td>Navigating Ways People Eat</td>
            </tr>
            <tr>
              <td colspan="2"></td>
              <td colspan="2">Brand and Product Prototyping</td>
            </tr>
            <tr>
              <td colspan="4"></td>
            </tr>
            ...
            <tr>
              <td></td>
              <td>Real Estate Development for Small Business Retail</td>
              <td>Staying on the Shelves</td>
              <td>How Festivals and Food Culture Shape Cities</td>
            </tr>
            <tr>
              <td colspan="2"></td>
              <td colspan="2">Getting Customers in the Door</td>
            </tr>
            <tr>
              <td colspan="4"></td>
            </tr>
            <tr class="primary">
              ...
              <td colspan="3">Specialty Food Association Happy Hour</td>
            </tr>
          </tbody>
        </table>
      ...
      <section id="sponsors">
        ...
        <div class="sponsor-logos clear">
          ...
          <div class="logo logo-3"><a href="http://tandem-made.com/"><img src="/z_logos/tandem_made.png" alt="Tandem"/></a></div>
          <div class="logo logo-3"><a href="http://www.madelenefarin.com/"><img src="/z_logos/madelene_farin.png" alt="Madelene Farin"/></a></div>
          <div class="logo logo-3"><a href="http://www.aedansf.com/"><img src="/z_logos/aedan.png" alt="Aedan Fermented Foods"/></a></div>
          <div class="logo logo-3"><a href="http://andapiroshki.com/"><img src="/z_logos/anda_piroshki.png" alt="Anda Piroshki"/></a></div>
          ...
          <!-- <div class="logo logo-3"><a href="http://cater2.me/"><img src="/z_logos/cater2me.png" alt="Cater2Me"/></a></div> -->
          ...
          <!-- <div class="logo logo-3"><a href="http://www.saveur.com/"><img src="/z_logos/saveur.png" alt="Saveur"/></a></div> -->
          ...
          <!-- <div class="logo logo-3"><a href="https://generalassemb.ly/"><img src="/z_logos/general_assembly.png" alt="General Assembly"/></a></div> -->
